...
_DOSE_TABLE = [
    ...
    # ── Antihistamines ────────────────────────────────────────────────────────
    {
        "aliases": ["cetirizine", "zyrtec", "cetzine", "alerid", "okacet"],
        "unit": "mg",
        "min_single": 5,
        "max_single": 10,
        "max_daily": 10,
        "typical_single": "10 mg",
        "typical_daily": "10 mg",
        "source": "WHO Model Formulary 2008, p. 434",
        "notes": "Adults and children ≥12 years: 10 mg OD or 5 mg BD. Do not exceed 10 mg/day.",
    },
    {
        "aliases": ["levocetirizine", "levocet", "xyzal", "levorid"],
        "unit": "mg",
        "min_single": 2.5,
        "max_single": 5,
        "max_daily": 5,
        ...
        "typical_daily": "5 mg",
        "source": "WHO Essential Medicines List 23rd edition (2023)",
        "notes": "Adults: 5 mg OD in the evening. Reduce to 2.5 mg OD in mild renal impairment. Max 5 mg/day.",
    },

    # ── Corticosteroids ───────────────────────────────────────────────────────
    {
        "aliases": ["prednisolone", "wysolone", "omnacortil", "hostacortin"],
        "unit": "mg",
        "min_single": 1,
        "max_single": 60,
        "max_daily": 80,
        "typical_single": "5–60 mg",
        "typical_daily": "5–60 mg",
        "source": "WHO Model Formulary 2008, p. 435",
        "notes": "Dose highly indication-dependent: replacement 7.5 mg/day; anti-inflammatory 5–60 mg/day; high-dose regimens (>60 mg) only under specialist supervision.",
    },
    {
        "aliases": ["dexamethasone", "decadron", "dexona", "dexamethasone"],
        "unit": "mg",
        "min_single": 0.5,
        "max_single": 10,
        "max_daily": 40,
        "typical_single": "0.5–10 mg",
        "typical_daily": "0.5–20 mg",
        "source": "WHO Model Formulary 2008, p. 435",
        "notes": "Anti-inflammatory/allergic: 0.5–9 mg/day. Cerebral oedema: 10 mg loading then 4 mg q6h. High-dose only under specialist supervision.",
    },

    # ── Beta-blockers ─────────────────────────────────────────────────────────
    {
        "aliases": ["metoprolol", "lopressor", "betaloc", "metolar", "seloken"],
        "unit": "mg",
        "min_single": 12.5,
        "max_single": 200,
        "max_daily": 400,
        "typical_single": "50–100 mg",
        "typical_daily": "100–200 mg",
        "source": "WHO Model Formulary 2008, p. 249",
        "notes": "Hypertension: 50–100 mg OD–BD. Angina: 50–100 mg BD–TDS. Heart failure: start 12.5–25 mg, uptitrate. Max 400 mg/day.",
    },
    {
        "aliases": ["bisoprolol", "concor", "bisocor", "cardicor"],
        "unit": "mg",
        "min_single": 1.25,
        "max_single": 10,
        "max_daily": 20,
        "typical_single": "2.5–10 mg",
        "typical_daily": "2.5–10 mg",
        "source": "WHO Essential Medicines List 23rd edition (2023)",
        "notes": "Once-daily dosing. Heart failure start 1.25 mg OD, uptitrate to max 10 mg OD. Hypertension max 20 mg/day.",
    },

    # ── Diuretics ─────────────────────────────────────────────────────────────
    {
        "aliases": ["hydrochlorothiazide", "hctz", "aquazide", "esidrex"],
        "unit": "mg",
        "min_single": 12.5,
        "max_single": 50,
        "max_daily": 100,
        "typical_single": "12.5–25 mg",
        "typical_daily": "12.5–50 mg",
        "source": "WHO Model Formulary 2008, p. 312",
        "notes": "Hypertension: 12.5–25 mg OD. Oedema: 25–50 mg OD–BD. Doses above 50 mg/day rarely provide additional antihypertensive benefit.",
    },
    {
        "aliases": ["spironolactone", "aldactone", "spiromide", "aldactide"],
        "unit": "mg",
        "min_single": 25,
        "max_single": 200,
        "max_daily": 400,
        "typical_single": "25–100 mg",
        "typical_daily": "25–200 mg",
        "source": "WHO Model Formulary 2008, p. 314",
        "notes": "Heart failure: 25–50 mg OD. Primary hyperaldosteronism: 100–400 mg/day pre-op. Max 400 mg/day.",
    },

    # ── Antiplatelet ──────────────────────────────────────────────────────────
    {
        "aliases": ["clopidogrel", "plavix", "clopilet", "deplatt"],
        "unit": "mg",
        "min_single": 75,
        "max_single": 600,
        "max_daily": 600,
        "typical_single": "75 mg (maintenance); 300–600 mg (loading)",
        "typical_daily": "75 mg",
        "source": "WHO Essential Medicines List 23rd edition (2023)",
        "notes": "Maintenance: 75 mg OD. Loading: 300 mg (ACS) or 600 mg (PCI) once only. Ongoing prescriptions >75 mg/day warrant review.",
    },

    # ── Thyroid ───────────────────────────────────────────────────────────────
    {
        "aliases": ["levothyroxine", "thyroxine", "eltroxin", "thyronorm", "thyrox"],
        "unit": "mcg",
        "min_single": 25,
        "max_single": 200,
        "max_daily": 300,
        "typical_single": "50–150 mcg",
        "typical_daily": "50–200 mcg",
        "source": "WHO Model Formulary 2008, p. 449",
        "notes": "Start 25–50 mcg OD, uptitrate by 25 mcg every 4 weeks. Usual maintenance 100–200 mcg OD. Doses >200 mcg/day suggest poor absorption or non-compliance; investigate before increasing.",
    },

    # ── Antimalarial / anti-inflammatory ─────────────────────────────────────
    {
        "aliases": ["hydroxychloroquine", "hcqs", "plaquenil", "quinoric"],
        "unit": "mg",
        "min_single": 200,
        "max_single": 400,
        "max_daily": 400,
        "typical_single": "200–400 mg",
        "typical_daily": "200–400 mg",
        "source": "WHO Model Formulary 2008, p. 164",
        "notes": "Max 5 mg/kg/day based on ideal body weight (WHO). Do not exceed 400 mg/day. Doses above 5 mg/kg/day significantly increase risk of irreversible retinopathy.",
    },

    # ── Anticonvulsants ───────────────────────────────────────────────────────
    {
        "aliases": ["gabapentin", "neurontin", "gabantin", "gabatop"],
        "unit": "mg",
        "min_single": 100,
        "max_single": 1200,
        "max_daily": 3600,
        "typical_single": "300–600 mg",
        "typical_daily": "900–1800 mg",
        "source": "WHO Essential Medicines List 23rd edition (2023)",
        "notes": "Start 300 mg OD, uptitrate to 300–600 mg TDS. Max 3600 mg/day (1200 mg TDS). Reduce dose in renal impairment.",
    },
    {
        "aliases": ["carbamazepine", "tegretol", "tegrital", "mazetol"],
        "unit": "mg",
        "min_single": 100,
        "max_single": 600,
        "max_daily": 1600,
        "typical_single": "100–400 mg",
        "typical_daily": "400–1200 mg",
        "source": "WHO Model Formulary 2008, p. 383",
        "notes": "Epilepsy: usual 400–1200 mg/day in divided doses. Max 1600 mg/day. Start low, uptitrate slowly due to autoinduction of metabolism.",
    },
    {
        "aliases": ["valproate", "sodium valproate", "valproic acid", "valparin", "encorate", "depakote"],
        "unit": "mg",
        "min_single": 200,
        "max_single": 1000,
        "max_daily": 2500,
        "typical_single": "200–500 mg",
        "typical_daily": "600–1500 mg",
        "source": "WHO Model Formulary 2008, p. 386",
        "notes": "Epilepsy: 600–2500 mg/day in 2–3 divided doses. Max 2500 mg/day. Teratogenic — avoid in women of childbearing age unless no alternative.",
    },

    # ── Antibiotic (additional) ───────────────────────────────────────────────
    {
        "aliases": ["erythromycin", "erythrocin", "althrocin", "erytop"],
        "unit": "mg",
        "min_single": 250,
        "max_single": 1000,
        "max_daily": 4000,
        "typical_single": "250–500 mg",
        "typical_daily": "1000–2000 mg",
        "source": "WHO Model Formulary 2008, p. 137",
        "notes": "Standard: 250–500 mg QID (1–2 g/day). Severe infections: 500 mg–1 g QID (up to 4 g/day). Take on empty stomach for best absorption.",
    },
]
